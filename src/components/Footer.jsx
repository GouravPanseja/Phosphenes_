      ...
      <div className="flex items-center justify-center w-full h-full p-4">
        <div className="flex items-center justify-center w-full h-full xs:p-2">
          <div className="flex items-center justify-center w-full h-full flex-col s:p-2">
            <div className="flex items-center justify-center w-full h-full flex-col gap-1 p-4 s:p-6 bg-[#f07800] sm:max-w-xl md:max-w-2xl lg:max-w-6xl xl:max-w-4xl  rounded-b-[44px] s:rounded-b-[64px] sm:rounded-b-[96px]  md:rounded-b-[144px]">
              ...
              <div className="flex-items-center justify-center w-full sm:w-[80%] md::w-[75%] my-4 xs:my-6">
                <h1 className="text-2xl xs:text-3xl  text-center s:text-4xl font-black sm:leading-tight text-white">
              ...
              <div className="flex items-center justify-center flex-row gap-4 md:mb-12 py-2 my-2 xs:my-6 w-full xs:w-[95%] sm:w-[75%] lg:w-[50%]">
               <Link to="https://forms.gle/V73pXU1xmP2JdNibA" className="flex items-center justify-center w-[85%] xs:w-full bg-black group hover:bg-transparent transition duration-200 ease-in-out hover:border hover:border-black rounded-full p-2 flex-1">
                <button type="submit" className=" text-[#f07800] group-hover:text-white rounded-full text-[.5rem] xs:text-xs font-black ">Register Now</button>
              </Link>
            ...
            <div className="flex items-center justify-around p-4 w-full h-full sm:flex-row flex-col gap-6">
                      <p className="text-[#f07800] font-black text-xs md:text-sm lg:text-base">PRIVACY POLICY</p>  
                      <p className="text-[#f07800] text-center font-black text-xs md:text-sm lg:text-base sm:ml-10">COPYRIGHT @ALL RIGHTS RESERVED</p>  
                      <p className="text-[#f07800] font-black text-xs md:text-sm lg:text-base">TERMS&CONDITIONS</p>  

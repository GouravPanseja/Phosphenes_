...
const Socials = () => {
  return (
    ...
    <div className="w-full h-full flex items-start justify-start flex-col p-6">
        ...
        <h1 className='text-[2rem]  xs:text-[2.7rem] s:text-6xl sm:text-[4rem] md:text-[5rem] lg:text-8xl xl:text-9xl 2xl:text-[154px] font-black sm:leading-tight text-[#ffffff] whitespace-nowrap'>SOCIALS <span className="text-[#f07800]">.</span></h1>
        </div>
        ...
        <div className='flex items-center s:justify-start justify-center  lg:justify-center gap-6 flex-1 flex-row p-2 w-full h-full'>
           ...
           <div className='w-full h-full flex items-center  justify-center flex-col gap-4'>
                 ...
                 <h1 className='text-[1.5rem]  lg:text-[2.7rem] font-black sm:leading-tight text-[#ffffff] whitespace-nowrap'>@codechef_cuiet</h1>
                 </Link>
                 </div>
           </div>
           </div>
        ...
        {/* <div className='flex md:items-start justify-center  md:flex-row flex-col-reverse py-6 mb-12 w-full h-full'>
           ...
           <div className='w-full h-full flex items-center md:items-end justify-center flex-col gap-4'>
                 <div className='flex items-center justify-start'>
                 <h1 className='text-[2.25rem]  xs:text-[2.7rem] sm:text-5xl lg:text-6xl font-black sm:leading-tight text-[#ffffff] whitespace-nowrap'>FOLLOW US <span className="text-[#f07800]">.</span></h1>
                 </div>
                
                 <div className='flex items-center justify-start'>
                 <Link to="https://www.linkedin.com/company/codechef-cuiet/" className='flex items-center justify-center'>
                 <h1 className='text-[1.5rem]  lg:text-[2.7rem] font-black sm:leading-tight text-[#ffffff] whitespace-nowrap'>@codechef_cuiet <span className="text-[#f07800]">.</span></h1>
                 </Link>
                 </div>
           </div>
           </div>

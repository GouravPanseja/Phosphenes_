  ...
  return (
    ...
    <div className="w-full h-full flex items-center justify-center flex-col py-4 lg:p-2">
      <div className="w-full h-full flex items-start justify-center flex-row py-2 lg:p-2">
        ...
        <h1 className='text-[2rem]  xs:text-[2.7rem] s:text-6xl sm:text-[4rem] md:text-[5rem] lg:text-8xl xl:text-9xl 2xl:text-[154px] font-black sm:leading-tight text-[#ffffff] whitespace-nowrap'>PAST EVENTS <span className="text-[#f07800]">.</span></h1>
        </div>
